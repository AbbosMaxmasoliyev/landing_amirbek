...
const Showcase = () => {
    return (
        <div id='home' className='flex xl:flex-col flex-col-reverse min-h-[85vh] overflow-hidden items-center justify-between relative'>
            <div className="flex flex-col xl:w-10/12 w-full p-4 xl:mb-5 xl:justify-end xl:h-[70vh] items-start  bg-gradient-to-t from-black via-black/85 to-transparent z-[3] xl:z-[unset]  xl:static   xl:bottom-[unset] bottom-0">
