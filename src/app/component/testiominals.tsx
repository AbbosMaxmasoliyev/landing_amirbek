    ...
    return (
        <div className="embla overflow-hidden bg-white text-black py-12 w-full" ref={emblaRef}>
            <div className="embla__container flex ">
                {infromation.map((info) => (
                    <div className="embla__slide flex-[0_0_100%] sm:flex-[0_0_50%] lg:flex-[0_0_33.33%] flex-col flex gap-3 p-3 border mr-12 rounded-xl">
